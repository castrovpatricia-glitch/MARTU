...
import Aprender from '../src/components/screens/Aprender.jsx'
import Lesson from '../src/components/screens/Lesson.jsx'
import Confusiones from '../src/components/screens/Confusiones.jsx'
import MapaMental from '../src/components/screens/MapaMental.jsx'
import RepasoInteligente from '../src/components/screens/RepasoInteligente.jsx'
import Construir from '../src/components/modes/Construir.jsx'
import Historia from '../src/components/modes/Historia.jsx'

import { ALL_QUESTIONS, getLevels, buildExam, CONCEPTS_FLAT } from '../src/data/index.js'
...
const mockGame = {
  state: {
    ...
    visited: { c6_imperativo: true }, conceptStates: { c6_imperativo: 'green' },
    storyChapters: {}, storyDone: false, built: {},
  },
  ...
  // aprendizaje
  markVisited() {}, setConceptState() {}, completeChapter() {}, markBuilt() {},
  conceptState: (id) => (id === 'c6_imperativo' ? 'green' : 'unseen'),
  visitedCount: 1, greenCount: 1, yellowCount: 0, redCount: 0, builtCount: 0, learnPct: 2, storyDoneCount: 0,
  examReqs: { visited: false, story: false, built: false }, examUnlocked: false, totalConcepts: CONCEPTS_FLAT.length,
...
console.log('— Pantallas de aprendizaje (nuevas) —')
test('Aprender', () => renderToString(jsx(Aprender, { game: mockGame, go })))
test('Lesson (concepto)', () => renderToString(jsx(Lesson, { conceptId: 'c10_psicologico', game: mockGame, go })))
test('Construir (picker)', () => renderToString(jsx(Construir, { game: mockGame, go })))
test('Construir (mundo)', () => renderToString(jsx(Construir, { game: mockGame, go, worldId: 'w1' })))
test('Confusiones', () => renderToString(jsx(Confusiones, { game: mockGame, go })))
test('Historia TechNova', () => renderToString(jsx(Historia, { game: mockGame, go })))
test('MapaMental', () => renderToString(jsx(MapaMental, { game: mockGame, go })))
test('RepasoInteligente', () => renderToString(jsx(RepasoInteligente, { game: mockGame, go })))
